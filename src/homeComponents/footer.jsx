        ...
        return (
            <footer class="page-footer font-small special-color-dark pt-4 ">
                ...
                <div className='flex-wrap' style={{textAlign:"center"}}>
                    <div className='m-2'><GitHubButton href="https://github.com/Priyanshi-Raj" data-show-count="true" aria-label="Follow @Priyanshi-Raj on GitHub">Follow @PriyanshiRaj</GitHubButton></div>
                ...
                <div class="footer-copyright text-center py-3">© 2022 Copyright:
                    <a href="https://github.com/Priyanshi-Raj" style={{color: "#65b6f0"}}> Priyanshi Raj </a>
                </div>
